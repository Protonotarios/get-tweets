...
μπορούμε να δημιουργήσουμε άμεσα διάφορα διαγράμματα καθώς περιέχει 
συγκεντρωτικά στοιχεία για όλους τους χρήστες.
...
Το πρώτο πράγμα που παρατηρούμε, που το γνωρίζαμε άλλωστε, είναι η τεράστια διαφορά 
...
Παρατηρούμε αμέσως ότι δεν τουϊτάρουν όλοι το ίδιο όλες τις ημέρες. Υπάρχουν
...
Αυτή η υπόθεση επιβεβαιώνεται ακόμα πιο περίτρανα από τα αγαπημένα ανά
ημέρα της εβδομάδας.

![διάγραμμα](αγαπημένα-ανά-ημέρα-εβδομάδας.png)

Εδώ παρατηρούμε ότι οι γραμμές τάσεις στα *like* του Αδώνιδος Γεωργιάδη και του 
Πάνου Καμμένου είναι πλέον έντονα ανοδικές από Δευτέρα προς το Σαββατοκύριακο 
και πλησιάζουν τη γραμμή της Ραχήλ Μακρή.

Το *like* είναι μια πιο παθητική διαδικασία σε σχέση με το 
retweet που απαιτεί μια μεγαλύτερη εμπλοκή με το θέμα. Από αυτήν την άποψη 
το διάγραμμα των *like* φανερώνει μια αντιπροσωπευτική συμπεριφορά χρηστών
που περνούν την ώρα τους. Αν αυτή λοιπόν είναι η χαρακτηριστική συμπεριφορά του
χομπίστα τότε ξανακοιτώντας το πρώτο διάγραμμα επιβεβαιώνουμε
ότι ο Άδωνις Γεωργιάδης και ο Πάνος Καμμένος κάθε άλλο παρά χομπίστες είναι.