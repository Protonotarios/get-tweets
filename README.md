...
Εκτελούμε το πρόγραμμα [get-tweets.py]() το οποίο δημιουργεί 3 αρχεία .csv που περιέχουν όλα τα tweets των τριών πολιτικών καθώς και κάποια μεταδεδομένα όπως αριθμός retweets, αριθμός favorites κ.ά.

Εκτελούμε και το πρόγραμμα [get-user-data.py]() το οποίο δημιουργεί το αρχείο `user data.csv` που περιέχει τα στοιχεία των λογαριασμών.
